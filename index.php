    ...
    <nav class="navbar navbar-expand-sm navbar-light">
      <div class="container">
        <a class="navbar-brand" href="index.html"
          ><i class="uil uil-user"></i> Dhaval</a
        >
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mx-auto">
            ...
            <div class="dropdown">
              <a href="#contact" class="nav-link"
              ><span data-hover="Contact">Projects</span></a
            >
        ...
        <div class="row">
            ...
            <div class="about-text">
              ...
              <h1 class="animated animated-text">
                ...
                <div class="animated-info">
                  <span class="animated-item">Web Develper</span>
                  <span class="animated-item">Web Designer</span>
                  <span class="animated-item">Dhaval Doriya</span>
              ...
              <div class="custom-btn-group mt-4">
                ...
                <a
                  href="https://dhavaldoriya.blogspot.com/"
          ...
          <div class="col-lg-5 col-md-12 col-12">
            <div class="about-image svg">
              <img
                src="images/undraw/programmer.svg"
                class="img-fluid"
                alt="svg image"
                width="400px"
                height="300px"
        ...
        <div class="row">
          <div class="col-lg-5 mr-lg-5 col-12">
            <div class="google-map w-100">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58665.83627301705!2d72.61052854505137!3d23.220705822256992!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395c2b987c6d6809%3A0xf86f06a7873e0391!2sGandhinagar%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1633277245701!5m2!1sen!2sin"
                width="400"
                height="300"
                frameborder="0"
                style="border: 0"
            ...
            >
              <div class="contact-info-item">
                ...
                <p>
                  <a href="mailto:dhavaldoriya19@gmail.com">dhavaldoriya19</a>
                </p>
              </div>
